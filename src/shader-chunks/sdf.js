...
float opRound( in float sdf, float rad )
{
    return sdf - rad;
}
...
{
    // float d = primitive(p.xy) // sdf2d prim
...
vec3 opDisplace( in vec3 p, in vec3 d )
{
